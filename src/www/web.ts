...
import { BrowserCallbacks, PluginError, SystemBrowserOptions, WebViewOptions, WebViewHiddenOptions, CallbackEvent, CallbackEventType } from "./definitions";
import { DefaultSystemBrowserOptions, DefaultWebViewOptions, DefaultWebViewHiddenOptions } from "./defaults";
...
function openInWebViewHidden(url: string, options: WebViewHiddenOptions, success: () => void, error: (error: PluginError) => void, browserCallbacks?: BrowserCallbacks, customHeaders?: { [key: string]: string } | null): void {
