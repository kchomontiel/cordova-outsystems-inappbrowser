...
module.exports = function (context) {
  try {
    console.log("🔧 [HiddenInAppBrowser] Force removal hook started");
    ...
    // Remove InAppBrowser plugin from all iOS projects
    ...
    console.log(
      "✅ [HiddenInAppBrowser] Force removal completed for all iOS projects"
    );
  } catch (error) {
    console.log(
      "❌ [HiddenInAppBrowser] Force removal hook error:",
      error.message
    );
